...
final class SimpleTracker {
    ...
    func update(detections: [Detection]) -> [TrackResult] {
        ...
        return tracks.map {
            TrackResult(trackID: $0.id, detection: $0.detection, isPredictionOnly: $0.isPredictionOnly)
        }
    }
